...
\lean{PadicField}
\leanfile{LeanBridge/PadicInv.lean}
\notready
...
\lean{PadicField.instIsDiscreteValuationRing}
\leanfile{LeanBridge/PadicInv.lean}
...
\lean{PadicField.Extension.ramificationIdx}
\leanfile{LeanBridge/PadicInv.lean}
\uses{prop:padic-is-dvf}
\mathlibok
...
\lean{PadicField.Extension.inertiaDeg}
\leanfile{LeanBridge/PadicInv.lean}
\uses{lem:OL-free}
\mathlibok
...
\lean{PadicField.Extension.differentExponent}
\leanfile{LeanBridge/PadicInv.lean}
\uses{def:ramification-index}
\mathlibok
...
\label{cor:tame-disc}
\lean{PadicField.Extension.discExponent_tame}
\leanfile{LeanBridge/PadicInv.lean}
